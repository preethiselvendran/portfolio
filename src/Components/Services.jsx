...
const Services = ({darkmode}) => {
  return (
  <div id='services' className={`container mx-auto px-5 py-10 scroll-mt-15 ${darkmode ? "bg-black text-white" : "bg-white text-black"} transition-colors duration-500`}>
    ...
    <div className='grid grid-cols-1 xl:grid-cols-4 gap-7 mt-10'>
        <div className=' px-5 py-2 rounded-md  shadow-xl hover:scale-110 hover:border hover:border-purple-700 group'>
  ...
  <div className='shadow-xl px-5 py-2 rounded-md hover:scale-110 hover:border hover:border-purple-700 group'>
  ...
  <div className='shadow-xl px-5 py-2 rounded-md hover:scale-110 hover:border hover:border-purple-700 group'>
            ...
            <h1 className='text-lg font-bold mt-3 text-purple-600 '>Responsive Web Design</h1>
  ...
  <div className='shadow-xl border-stone-500 px-5 py-2 rounded-md hover:scale-110 hover:border hover:border-purple-700 group'>
            <FaLaptopCode className='size-6'/>
