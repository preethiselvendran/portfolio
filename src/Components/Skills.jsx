...
const Skills = ({ darkmode }) => {
  ...
  duration-500 scroll-mt-15`}>
    <div className='text-center'>
      <h1 className='text-2xl font-bold text-violet-700 mt-40'>My Skills</h1>
    ...
    <div className='grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-5 mt-7 flex-wrap'>
      ...
      {/* Frontend Skills */}
      <div className='border border-stone-500 mt-7 px-8 py-2 rounded-lg hover:border-l-4
       hover:border-l-purple-700 hover:border-b-4 hover:border-b-purple-700'>
  ...
  <div className='flex items-center gap-2'>
    ...
    <p>Responsive Web Design</p>
      ...
      {/* Styling Framework */}
      <div className='hover:border-l-4 hover:border-l-purple-700 hover:border-b-4 hover:border-b-purple-700 mt-7 px-8 py-2 rounded-lg border border-stone-500'>
        <h1 className='flex items-center gap-2 font-bold'>
      ...
      {/* Frontend Libraries */}
      <div className='border border-stone-500 mt-7 px-8 py-2 rounded-lg hover:border-l-4 hover:border-l-purple-700 hover:border-b-4 hover:border-b-purple-700'>
        <h1 className='flex items-center gap-2 font-bold'>
